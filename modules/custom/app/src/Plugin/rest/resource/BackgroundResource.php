...
/**
 * @file
 * Contains \Drupal\app\Plugin\rest\resource\BackgroundResource.
 */
 ...
 *
 * @RestResource(
 *   id = "background_resource",
 *   label = @Translation("Svg resource"),
 *   uri_paths = {
 *     "canonical" = "/lifebook/background/{dir}"
 *   }
 * )
 */
class BackgroundResource extends ResourceBase {
  /**
